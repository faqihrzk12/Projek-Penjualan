            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Edit Pembeli</h6>
                </div>
                <div class="card-body">
                  <form class="form-horizontal" action="<?php echo base_url('admin/updatepembeli')?>" method="post" name="form">
                      ...
                      <div class="col-sm-4 control-label">
                        ...
                        <a href="../../admin/pelanggan" class="btn btn-secondary btn-sm float-right"><i class="fas fa-arrow-left"></i> Kembali</a>
                      </div>
                    </form>
                </div>
              </div>
