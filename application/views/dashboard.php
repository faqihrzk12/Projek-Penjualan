...
<body id="page-top">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $total_penjualan_header;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Penjualan 2020</h6>
  ...
  foreach ($penjualan_report as $penjualan) {
    $new[$penjualan['bulan']] = (int)$penjualan['total_grand_total'];
  }
?>
  ...
  <!-- Page level plugins -->
  <script src="<?php echo $vendorDirectory?>vendor/chart.js/Chart.min.js"></script>
  <script>

  var penjualan_report = <?php echo json_encode($new);?>;
